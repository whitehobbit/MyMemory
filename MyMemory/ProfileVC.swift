...
class ProfileVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let bg = #imageLiteral(resourceName: "profile-bg")
...
//        let image = #imageLiteral(resourceName: "account")
        ...
        self.tv.frame = CGRect(x: 0,
                               y: self.profileImage.frame.origin.y + self.profileImage.frame.size.height + 20, width: self.view.frame.width,
                               height: 100)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.detailTextLabel?.text = self.uinfo.name ?? "Login please" //"whitehobbit"
        case 1:
            cell.textLabel?.text = "계정"
            cell.detailTextLabel?.text = self.uinfo.account ?? "Login please" //"limhabin@gmail.com"
        default:
            ()
        }
